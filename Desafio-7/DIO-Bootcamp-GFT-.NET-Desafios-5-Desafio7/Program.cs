...
//para cada uma destas notas e mostre esta média acompanhada pela mensagem "Media: ". Se esta média for maior ou igual a 7.0,
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (avg > 5 && avg < 7)
            {
                ...
                Console.WriteLine("Nota do exame:" + e);
