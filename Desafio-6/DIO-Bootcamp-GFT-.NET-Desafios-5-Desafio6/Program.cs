...
//organiza essa competição todos os anos, mas nunca conseguiram entrar para o livro dos recordes, o Guinness Book. Para isso,
//o restaurante precisa preencher informações sobre a competição, como o número de coxinhas consumidas pelos competidores durante o evento. 
...
namespace Introducao
{
    class CoxinhaDeBueno
    {
        ...
        {
            Console.WriteLine("Digite o número total de coxinhas consumidas e o número total de participantes.");
